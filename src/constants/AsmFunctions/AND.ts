...
const AND_TABLE = new HashMap<InstructionStructure, OpCode>()
  ...
  .set({operation: 'and', operand1: 'r16', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '4', isSigned: true })
  .set({operation: 'and', operand1: 'm16', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '4', isSigned: true })
  .set({operation: 'and', operand1: 'r32', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '4', isSigned: true })
  .set({operation: 'and', operand1: 'm32', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '4', isSigned: true })
