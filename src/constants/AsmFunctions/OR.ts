...
const OR_TABLE = new HashMap<InstructionStructure, OpCode>()
  ...
  .set({operation: 'or', operand1: 'r16', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '1', isSigned: true})
  .set({operation: 'or', operand1: 'm16', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '1', isSigned: true})
  .set({operation: 'or', operand1: 'r32', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '1', isSigned: true})
  .set({operation: 'or', operand1: 'm32', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '1', isSigned: true})
  .set({operation: 'or', operand1: 'r8', operand2: 'r8'}, {opCode: '83', length: 'b', modRmByte: '1', isSigned: true})
