...
export const generateCode = (op1?: string, op2?: string, ins?: string, ptrType?: ptrType, err?: any[], table?: HashMap<InstructionStructure, string>) => {
...
export const formatSpecificOp = (op: string, opType: operandType[], position: 1 | 2) => {
    ...
    if (hasType(opType, 'disp')) {
        const bracketsRemoved = removeBrackets(op!);
        if (opType?.includes('neg')) {
...
export const formatOps = (opCode: string, op1?: string, op2?: string, op1Type?: operandType[], op2Type?: operandType[]) => {
...
export const convertModRmByte = (opCode: string, rmByte: string, op: { op2: string | undefined; op1: string | undefined; type2: operandType[] | undefined; type1: operandType[] | undefined }): string => {
    ...
    if (isOp1Sib || isOp2Sib) {
        const [nonSibOp, sibTyp, sibOp, nonSibType] = (isOp1Sib ? [op.op2, op.type1, op.op1, op.type2] : [op.op1, op.type2, op.op2, op.type1]) as [any, operandType[], any, operandType[]];
