...
const ADC_TABLE = new HashMap<InstructionStructure, OpCode>()
  ...
  .set({operation: 'adc', operand1: 'r16', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '2', isSigned: true})
  .set({operation: 'adc', operand1: 'm16', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '2', isSigned: true})
  .set({operation: 'adc', operand1: 'r32', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '2', isSigned: true})
  .set({operation: 'adc', operand1: 'm32', operand2: 'imm8'}, {opCode: '83', length: 'b', modRmByte: '2', isSigned: true})
